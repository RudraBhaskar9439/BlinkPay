...
- [ ] Optional social post published and linked for the viral prize.

## Judging-agent checks

- [x] First implementation commit is after Spark opened on July 13, 2026.
- [x] Meaningful phase-by-phase commit history is preserved.
- [x] Live balances, quotes, simulations, receipts, and replay state replace
